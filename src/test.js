...
var topics = [
  ...
  "0x000000000000000000000000b2e5fb92d905f3c9cf50800b6212600c7e220d6b",
  "0x00000000000000000000000007fa1874ad4655ad0c763a7876503509be11e29e",
];
var data =
  "0x000000000000000000000000000000000000000000000cea2a85d7ba33700000000000000000000000000000000045f18d8bef7a599ca4fcd103fc9123876dd2";
...
var electionproxy_voterevoked_topic =
  '["0xae7458f8697a680da6be36406ea0b8f40164915ac9cc40c0dad05a2ff6e8c6a8","0x0000000000000000000000000e7f5e44ee4f6ede5fd5a32c9e65bc041b25e2f1"]';
result = thecelo.eth_rpc(
  "eth_getLogs",
  '[{"fromBlock": "earliest","toBlock":"latest","address":"' +
    contract +
    '","topics":' +
    electionproxy_voterevoked_topic +
    "}]"
);
//console.log(result);
/////////////////////////////////////////////////
/////////////////////////////////////////////////
var method = web3.eth.abi.encodeEventSignature({
  type: "event",
...
method = web3.eth.abi.encodeEventSignature({
  type: "event",
...
var result = web3.eth.abi.encodeFunctionSignature(
