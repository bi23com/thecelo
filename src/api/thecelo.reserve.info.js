...
var bittrex_celo_url = 'https://bittrex.com/v3/markets/CELO-USDT/candles/DAY_1/recent';
...
async function getReserveInfo(){
  ...
  result['btc'] = [btc_addr,btc_info.final_balance/1e+8,btc_price];
  //
  ...
  result['eth'] = [eth_addr,eth_info.final_balance/1e+18,parseFloat(eth_price)];
  //
  ...
  result['dai'] = [dai_addr,dai_info.result/1e+18,parseFloat(dai_price)];
  //
  result['unfrozenReserveGoldBalance'] = parseInt(eth_call('getUnfrozenReserveGoldBalance'))/1e+18;
  result['otherReserveAddressesGoldBalance'] = parseInt(eth_call('getOtherReserveAddressesGoldBalance'))/1e+18;
  result['reserveGoldBalance'] = parseInt(eth_call('getReserveGoldBalance'))/1e+18;
  result['unfrozenBalance'] = parseInt(eth_call('getUnfrozenBalance'))/1e+18;
  result['frozenReserveGoldBalance'] = parseInt(eth_call('getFrozenReserveGoldBalance'))/1e+18;
  result['reserveRatio'] = parseInt(eth_call('getReserveRatio'))/1e+18;
  //
