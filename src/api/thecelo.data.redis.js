...
if(process.argv.length<3)
{
  ...
  if(type == 'update-groups'){
    ...
    if(process.argv.length<4){
      ...
      console.log('Example : node thecelo.data.redis.js query-keybase 0xfFAC3DcF14DC8e678204E2388031d4cc3e366261');
      exit();
    }
    else{
  ...
  //
    ...
    if(process.argv.length<6){
      ...
      console.log('Example : node thecelo.data.redis.js add-keybase 0xfFAC3DcF14DC8e678204E2388031d4cc3e366261 "sunxmldapp" "https://bi23.com"');
    }
    else{
      ...
      var cmd = "curl \
        ...
        console.log(logo);
        //
        var twitter  =json['them']['proofs_summary']['by_presentation_group']['twitter'][0]['service_url'];
        console.log(twitter);
        //
        var github  =json['them']['proofs_summary']['by_presentation_group']['github'][0]['service_url'];
        console.log(github);
        var ids = new Array();
        ids.push(address);
        ids.push(username);
